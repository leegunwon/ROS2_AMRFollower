...
#include "my_interfaces/msg/detail/object_data__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/int32_multi_array__functions.h"  // position
...
using _ObjectData__ros_msg_type = my_interfaces__msg__ObjectData;
...
size_t get_serialized_size_my_interfaces__msg__ObjectData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectData__ros_msg_type * ros_message = static_cast<const _ObjectData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__ObjectData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__msg__ObjectData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__msg__ObjectData;
    is_plain =
      (
...
static size_t _ObjectData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_my_interfaces__msg__ObjectData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, ObjectData)() {
